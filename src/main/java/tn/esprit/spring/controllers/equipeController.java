...
import tn.esprit.spring.services.ExportEquipeService;
...
return  new ResponseEntity<>(this.equipeService.findAll(page, size), HttpStatus.OK);
    ...
    public List<Equipe> findNom(@PathVariable String nomEquipe) {
        return repo.findEquipesByNomEquipe();
    }
